#!/bin/bash
#SBATCH --job-name=fbuta-c_0
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --array=0-35
#SBATCH --partition=short
#SBATCH --output=/home/unibas/boittier/FDCM/out_files/fbuta-c_0_%A-%a.out
