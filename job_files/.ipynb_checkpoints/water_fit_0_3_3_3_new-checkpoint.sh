#!/bin/bash
#SBATCH --job-name=water_fit_0_3_3_3_new
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --output=/home/boittier/FDCM/out_files/water_fit_0_3_3_3_new.out
hostname
...
output_dir="water_fit_0_3_3_3_new"
frames="/home/boittier/v1/frames.txt"
initial_fit="/home/boittier/FDCM/water_fit/2_2_3/global_fitted_global.xyz"
initial_fit_cube="/home/boittier/v1/2_2_3_new"
