#!/bin/bash
#SBATCH --job-name=water_2_2_2_new
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --output=/home/boittier/FDCM/out_files/water_2_2_2_new.out
hostname
